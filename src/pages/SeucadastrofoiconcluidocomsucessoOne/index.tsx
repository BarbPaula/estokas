...
const SeucadastrofoiconcluidocomsucessoOnePage: React.FC = () => {
  ...
  const table7Columns = React.useMemo(() => {
    ...
    return [
      table7ColumnHelper.accessor("nome", {
        cell: (info) => (
          <Text
      ...
      table7ColumnHelper.accessor("categoria", {
        cell: (info) => (
      ...
      table7ColumnHelper.accessor("integrado", {
        cell: (info) => (
          <Text
      ...
      table7ColumnHelper.accessor("aes", {
        cell: (info) => (
  ...
  const [group428value, setGroup428value] = React.useState<string>("");
        ...
        <div className="h-[1024px] overflow-auto md:px-5 relative w-full">
          <div className="absolute h-[1024px] inset-[0] justify-center m-auto w-full">
                    ...
                    <Input
                      ...
                      suffix={
                        <CloseSVG
                          fillColor="#6c6c6c"
                          className="cursor-pointer h-5 my-auto"
                          onClick={() => setGroup428value("")}
                          style={{
                            visibility:
                              group428value?.length <= 0 ? "hidden" : "visible",
                          }}
                          height={20}
                          width={20}
                          viewBox="0 0 20 20"
            ...
            <Img
              ...
              src="images/img_rectangle2065_1.png"
              alt="rectangle2065"
            />
            <div className="absolute bg-blue_gray-900_b2 flex flex-col h-full inset-[0] items-start justify-center m-auto p-[206px] md:px-10 sm:px-5 w-full">
              <div className="bg-gray-100 flex flex-col items-center justify-start mb-[9px] md:ml-[0] ml-[163px] p-[63px] md:px-10 sm:px-5 rounded-[20px] w-[63%] md:w-full">
                ...
                <Img
                  ...
                  alt="maskgroup"
                />
                <div className="flex flex-col font-lato items-center justify-start mb-[3px] mt-[76px] w-[93%] md:w-full">
                  <Button
                    className="cursor-pointer font-bold min-w-[480px] sm:min-w-full rounded-[12px] text-center text-lg"
                    color="blue_gray_900"
                    size="xl"
                    variant="fill"
                  >
...
export default SeucadastrofoiconcluidocomsucessoOnePage;
