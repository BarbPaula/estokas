...
const TutorialdaplataformaPage: React.FC = () => {
  const table9Data = React.useRef<Table9RowType[]>([
    {
  ...
  const table9Columns = React.useMemo(() => {
    const table9ColumnHelper = createColumnHelper<Table9RowType>();
    return [
      table9ColumnHelper.accessor("nome", {
        cell: (info) => (
          <Text
      ...
      table9ColumnHelper.accessor("categoria", {
        cell: (info) => (
      ...
      table9ColumnHelper.accessor("integrado", {
        cell: (info) => (
          <Text
      ...
      table9ColumnHelper.accessor("aes", {
        cell: (info) => (
        ...
        <div className="h-[1024px] overflow-auto md:px-5 relative w-full">
          <div className="absolute h-[1024px] inset-[0] justify-center m-auto w-full">
            ...
            <Img
              ...
              src="images/img_rectangle2065_3.png"
              alt="rectangle2065"
            />
            <div className="absolute bg-blue_gray-900_b2 flex flex-col h-full inset-[0] items-center justify-center m-auto p-[89px] md:px-10 sm:px-5 w-full">
              <div className="bg-gray-100 flex flex-col items-center justify-end mt-[85px] p-[26px] sm:px-5 rounded-[20px] w-3/4 md:w-full">
                ...
                <Button
                  className="cursor-pointer font-bold font-lato min-w-[480px] sm:min-w-full mt-[34px] rounded-[12px] text-center text-lg"
                  color="blue_gray_900"
                  size="xl"
                  variant="fill"
                >
...
export default TutorialdaplataformaPage;
